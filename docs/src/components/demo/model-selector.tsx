...
export default function ModelSelector({
  ...
  return (
    <div className="grid grid-cols-[140px_1fr_1fr] gap-2.5 items-end">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="flex items-center gap-2 bg-surface-3 border border-border px-2.5 py-[7px] rounded-app">
          ...
          {selected && (
            <span className="ml-auto text-[9px] px-1.5 py-px rounded-sm border border-border-2 text-text-dim">
