...
- `~anthropic/claude-opus-latest` — changed: default_parameters
- `~anthropic/claude-sonnet-latest` — changed: default_parameters
- `~deepseek/deepseek-v4-flash-latest` — changed: context_length, pricing
...
- `anthropic/claude-opus-4.5` — changed: default_parameters, benchmarks
- `anthropic/claude-opus-4.5:batch` — changed: default_parameters, benchmarks
- `anthropic/claude-opus-4.6` — changed: default_parameters, benchmarks
- `anthropic/claude-opus-4.6:batch` — changed: default_parameters, benchmarks
- `anthropic/claude-opus-4.7` — changed: default_parameters, benchmarks
- `anthropic/claude-opus-4.7:batch` — changed: default_parameters, benchmarks
- `anthropic/claude-opus-4.8` — changed: default_parameters, benchmarks
- `anthropic/claude-opus-4.8:batch` — changed: default_parameters, benchmarks
- `anthropic/claude-opus-5` — changed: default_parameters, benchmarks
- `anthropic/claude-opus-5:batch` — changed: default_parameters, benchmarks
...
- `anthropic/claude-sonnet-4.6` — changed: default_parameters, benchmarks
- `anthropic/claude-sonnet-4.6:batch` — changed: default_parameters, benchmarks
- `anthropic/claude-sonnet-5` — changed: default_parameters, benchmarks
- `anthropic/claude-sonnet-5:batch` — changed: default_parameters, benchmarks
...
- `deepseek/deepseek-v3.1-terminus` — changed: pricing, top_provider, expiration_date, benchmarks
...
- `deepseek/deepseek-v4-flash-0731` — changed: context_length, benchmarks
...
- `google/gemma-4-26b-a4b-it:free` — changed: top_provider
...
- `openai/gpt-5.6-sol-pro:batch` — changed: pricing
- `openai/gpt-5.6-sol:batch` — changed: pricing
...
- `x-ai/grok-4.6` — changed: supported_parameters, benchmarks
- `x-ai/grok-build-0.1` — changed: supported_parameters
