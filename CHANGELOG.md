...
- `~anthropic/claude-opus-latest` — changed: alias_target
...
- `anthropic/claude-opus-5` — changed: name, benchmarks
- `anthropic/claude-opus-5:batch` — changed: name, benchmarks
...
- `mistralai/mistral-small-3.2-24b-instruct` — changed: pricing, top_provider
