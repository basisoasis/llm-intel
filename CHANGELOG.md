...
- `~anthropic/claude-opus-latest` — changed: top_provider, reasoning
- `~anthropic/claude-sonnet-latest` — changed: top_provider, reasoning
...
- `inclusionai/ling-3.0-flash:free` — changed: default_parameters, reasoning
...
- `minimax/minimax-m2` — changed: pricing, benchmarks
...
- `qwen/qwen3-next-80b-a3b-instruct` — changed: pricing
