...
- `deepseek/deepseek-chat-v3-0324` — changed: pricing, benchmarks
...
- `mistralai/mistral-medium-3-5:batch` — changed: context_length, top_provider, benchmarks
...
- `qwen/qwen3-14b` — changed: pricing, top_provider, benchmarks
...
- `qwen/qwen3-30b-a3b` — changed: supported_parameters, benchmarks
...
- `tencent/hy4-preview` — changed: hugging_face_id
...
- `z-ai/glm-4.7-flash` — changed: pricing, top_provider, expiration_date, benchmarks
