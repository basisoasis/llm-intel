...
- `deepseek/deepseek-r1` — changed: supported_parameters
...
- `inference-net/schematron-v2-small` — changed: pricing
- `inference-net/schematron-v2-turbo` — changed: pricing
...
- `moonshotai/kimi-k2` — changed: top_provider
- `moonshotai/kimi-k2-0905` — changed: top_provider
- `moonshotai/kimi-k2-thinking` — changed: top_provider
