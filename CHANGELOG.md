...
- `deepseek/deepseek-v4-flash-0731:batch` — changed: pricing, supported_parameters, benchmarks
...
- `deepseek/deepseek-v4-pro-0813:batch` — changed: pricing, supported_parameters
...
- `meta/muse-glimmer-30b:batch` — changed: pricing, supported_parameters
...
- `nvidia/nemotron-3-super-120b-a12b` — changed: context_length, supported_parameters
...
- `z-ai/glm-5.3-flash:batch` — changed: context_length, pricing, top_provider
