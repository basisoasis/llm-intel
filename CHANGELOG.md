...
- `arcee-ai/trinity-large-thinking` — changed: pricing, top_provider, benchmarks
...
- `deepseek/deepseek-v4-flash` — changed: pricing
...
- `mistralai/devstral-2512` — changed: pricing
