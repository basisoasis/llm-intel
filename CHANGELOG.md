...
- **Perceptron: Perceptron Mk1.5** (`perceptron/perceptron-mk1.5`)
- **TypeSafe: Jev Router** (`typesafe/jev-router`)
...
- `anthropic/claude-fable-5.1:batch` — changed: benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
- `anthropic/claude-haiku-4.5:batch` — changed: benchmarks
...
- `google/gemini-3.5-flash:batch` — changed: benchmarks
- `google/gemini-3.6-flash` — changed: benchmarks
- `google/gemini-3.6-flash:batch` — changed: benchmarks
...
- `google/gemma-4-26b-a4b-it` — changed: pricing
- `inception/mercury-2` — changed: benchmarks
- `inclusionai/ling-3.0-flash-vl` — changed: pricing, top_provider
...
- `nvidia/nemotron-3.5-lightning` — changed: context_length
...
- `qwen/qwen-plus-2025-07-28` — changed: expiration_date
- `qwen/qwen3-235b-a22b` — changed: expiration_date, benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: expiration_date, benchmarks
- `qwen/qwen3-30b-a3b` — changed: benchmarks
- `qwen/qwen3-30b-a3b-thinking-2507` — changed: expiration_date, benchmarks
- `qwen/qwen3-8b` — changed: expiration_date
- `qwen/qwen3-coder` — changed: benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: benchmarks
- `qwen/qwen3-coder-plus` — changed: expiration_date
- `qwen/qwen3-max` — changed: expiration_date, benchmarks
- `qwen/qwen3-max-thinking` — changed: expiration_date
- `qwen/qwen3-vl-235b-a22b-thinking` — changed: expiration_date
- `qwen/qwen3-vl-30b-a3b-thinking` — changed: expiration_date
- `qwen/qwen3-vl-32b-instruct` — changed: expiration_date
- `qwen/qwen3-vl-8b-instruct` — changed: expiration_date
- `qwen/qwen3-vl-8b-thinking` — changed: expiration_date
...
- `qwen/qwen3.6-max-preview` — changed: expiration_date
...
- `thinkingmachines/inkling` — changed: context_length, benchmarks
- `thinkingmachines/inkling-small` — changed: context_length
...
- `x-ai/grok-4.3:batch` — changed: benchmarks
...
- `xiaomi/mimo-v2.6-pro` — changed: context_length, benchmarks
...
- `z-ai/glm-5.3-flash` — changed: pricing, benchmarks
...
- **AionLabs: Aion 3.5 Mini** (`aion-labs/aion-3.5-mini`)
...
- **Upstage: Solar Mini 4** (`upstage/solar-mini4`)
...
- `~deepseek/deepseek-flash-latest` — changed: pricing
- `~deepseek/deepseek-pro-latest` — changed: pricing, top_provider
- `~deepseek/deepseek-v4-flash-latest` — changed: pricing
- `~moonshotai/kimi-latest` — changed: pricing
- `amazon/nova-premier-v1` — changed: benchmarks
...
- `google/gemini-3.8-flash:batch` — changed: benchmarks
- `inception/mercury-2` — changed: benchmarks
- `inclusionai/ling-3.0-flash-vl` — changed: context_length, supported_parameters
- `liquid/lfm-2.5-2.6b:free` — changed: supported_parameters
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
- `meta/muse-spark-1.3` — changed: benchmarks
- `minimax/minimax-m2` — changed: pricing, top_provider, benchmarks
- `minimax/minimax-m2.1` — changed: benchmarks
- `minimax/minimax-m2.5` — changed: benchmarks
- `minimax/minimax-m2.7` — changed: benchmarks
- `minimax/minimax-m3` — changed: benchmarks
...
- `qwen/qwen3-next-80b-a3b-instruct` — changed: pricing, top_provider
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: benchmarks
...
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `tencent/hy4-preview` — changed: supported_parameters
...
- `z-ai/glm-5.3-flash:batch` — changed: benchmarks
- `z-ai/glm-5.3-flashx` — changed: pricing, expiration_date
- `z-ai/glm-5.3:batch` — changed: pricing, benchmarks
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- `~anthropic/claude-fable-latest` — changed: supported_parameters
- `~deepseek/deepseek-flash-latest` — changed: pricing
- `~deepseek/deepseek-pro-latest` — changed: pricing, top_provider
- `~deepseek/deepseek-v4-flash-latest` — changed: pricing
- `~z-ai/glm-flash-latest` — changed: top_provider
- `~z-ai/glm-latest` — changed: pricing, top_provider
- `amazon/nova-premier-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-fable-5:batch` — changed: benchmarks
- `anthropic/claude-fable-5.1` — changed: supported_parameters, benchmarks
- `anthropic/claude-fable-5.1:batch` — changed: benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
- `anthropic/claude-haiku-4.5:batch` — changed: benchmarks
...
- `google/gemini-3.8-flash` — changed: benchmarks
- `google/gemini-3.8-flash:batch` — changed: benchmarks
- `ibm-granite/granite-4.2-8b` — changed: pricing
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-3.1-70b-instruct` — changed: pricing, top_provider
- `meta-llama/llama-4-maverick` — changed: pricing, top_provider, benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
...
- `qwen/qwen-2.5-coder-32b-instruct` — changed: supported_parameters
- `qwen/qwen3-235b-a22b` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-30b-a3b` — changed: benchmarks
...
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `qwen/qwen3.8-27b` — changed: pricing, top_provider
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: benchmarks
...
- `~moonshotai/kimi-latest` — changed: pricing
- `~z-ai/glm-flash-latest` — changed: supported_parameters
- `~z-ai/glm-latest` — changed: pricing, top_provider
- `amazon/nova-premier-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-fable-5:batch` — changed: benchmarks
...
- `anthropic/claude-opus-4.6` — changed: benchmarks
- `anthropic/claude-opus-4.6:batch` — changed: benchmarks
- `anthropic/claude-opus-4.7` — changed: top_provider
- `anthropic/claude-opus-4.8` — changed: benchmarks
- `anthropic/claude-opus-4.8:batch` — changed: benchmarks
- `anthropic/claude-opus-5` — changed: benchmarks
- `anthropic/claude-opus-5:batch` — changed: benchmarks
...
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-glimmer-30b` — changed: pricing
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
- `meta/muse-spark-1.3` — changed: benchmarks
- `minimax/minimax-m2` — changed: benchmarks
...
- `mistralai/mistral-medium-3.1` — changed: benchmarks
- `mistralai/mistral-medium-3.1:batch` — changed: benchmarks
- `mistralai/mistral-small-2603` — changed: supported_parameters
- `moonshotai/kimi-k2` — changed: benchmarks
- `moonshotai/kimi-k2-0905` — changed: benchmarks
- `moonshotai/kimi-k2.5` — changed: benchmarks
- `moonshotai/kimi-k2.6` — changed: benchmarks
...
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-5.5:batch` — changed: benchmarks
- `openai/gpt-oss-120b` — changed: pricing, top_provider, benchmarks
- `openai/gpt-oss-120b:batch` — changed: benchmarks
- `openai/gpt-oss-20b` — changed: benchmarks
- `openai/o4-mini` — changed: benchmarks
- `openai/o4-mini:batch` — changed: benchmarks
...
- `z-ai/glm-4.5` — changed: benchmarks
- `z-ai/glm-4.5-air` — changed: benchmarks
- `z-ai/glm-4.6` — changed: pricing, top_provider, benchmarks
- `z-ai/glm-4.7` — changed: benchmarks
- `z-ai/glm-4.7-flash` — changed: benchmarks
- `z-ai/glm-5` — changed: benchmarks
- `z-ai/glm-5-turbo` — changed: benchmarks
...
- `z-ai/glm-5.2:free` — changed: benchmarks
- `z-ai/glm-5.3` — changed: benchmarks
- `z-ai/glm-5.3-flash` — changed: supported_parameters, benchmarks
- `z-ai/glm-5.3-flash:batch` — changed: benchmarks
- `z-ai/glm-5.3:batch` — changed: benchmarks
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- `google/gemini-3.8-flash:batch` — changed: benchmarks
- `inception/mercury-2` — changed: benchmarks
- `inclusionai/ling-3.0-flash-fin` — changed: supported_parameters
- `meta-llama/llama-4-maverick` — changed: pricing, top_provider
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta-llama/llama-guard-4-12b` — changed: supported_parameters
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
- `meta/muse-spark-1.3` — changed: benchmarks
- `minimax/minimax-m2.1` — changed: benchmarks
...
- `moonshotai/kimi-k3` — changed: benchmarks
- `moonshotai/kimi-k3:batch` — changed: benchmarks
- `nousresearch/hermes-3-llama-3.1-70b` — changed: supported_parameters
- `nvidia/nemotron-3-super-120b-a12b` — changed: pricing, top_provider
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `nvidia/nemotron-3.5-content-safety` — changed: supported_parameters
- `openai/gpt-4.1-mini` — changed: benchmarks
- `openai/gpt-4.1-mini:batch` — changed: benchmarks
- `openai/gpt-5` — changed: benchmarks
- `openai/gpt-5-image` — changed: benchmarks
...
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `sao10k/l3.1-euryale-70b` — changed: supported_parameters
- `stepfun/step-3.7-flash` — changed: benchmarks
- `thinkingmachines/inkling` — changed: supported_parameters, benchmarks
- `thinkingmachines/inkling:batch` — changed: benchmarks
- `thinkingmachines/inkling:free` — changed: benchmarks
- `upstage/solar-pro4` — changed: benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
...
- `anthropic/claude-opus-4.6:batch` — changed: benchmarks
- `anthropic/claude-opus-4.7` — changed: top_provider
- `anthropic/claude-opus-4.8` — changed: top_provider, benchmarks
- `anthropic/claude-opus-4.8:batch` — changed: benchmarks
- `anthropic/claude-opus-5` — changed: benchmarks
- `anthropic/claude-opus-5:batch` — changed: benchmarks
- `anthropic/claude-sonnet-4` — changed: benchmarks
...
- `mistralai/mistral-medium-3.1` — changed: benchmarks
- `mistralai/mistral-medium-3.1:batch` — changed: benchmarks
- `mistralai/mistral-small-3.2-24b-instruct` — changed: context_length, benchmarks
- `moonshotai/kimi-k2` — changed: benchmarks
- `moonshotai/kimi-k2.5` — changed: benchmarks
- `moonshotai/kimi-k2.6` — changed: benchmarks
- `moonshotai/kimi-k2.7-code` — changed: benchmarks
...
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-5.5:batch` — changed: benchmarks
- `openai/gpt-6-astra-pro` — changed: top_provider
- `openai/gpt-oss-120b` — changed: benchmarks
- `openai/gpt-oss-120b:batch` — changed: benchmarks
- `openai/gpt-oss-20b` — changed: benchmarks
- `openai/gpt-oss-20b:batch` — changed: benchmarks
...
- `google/gemini-3.8-flash` — changed: benchmarks
- `google/gemini-3.8-flash:batch` — changed: benchmarks
- `google/gemma-4-26b-a4b-it` — changed: pricing, top_provider
- `ibm-granite/granite-4.2-8b` — changed: benchmarks
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-3.1-70b-instruct` — changed: pricing, top_provider
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
...
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: benchmarks
- `thinkingmachines/inkling-small:free` — changed: supported_parameters
- `thinkingmachines/inkling:batch` — changed: benchmarks
- `thinkingmachines/inkling:free` — changed: benchmarks
- `upstage/solar-pro4` — changed: pricing, benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.3:batch` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
...
- `z-ai/glm-4.6` — changed: benchmarks
- `z-ai/glm-4.7` — changed: benchmarks
- `z-ai/glm-4.7-flash` — changed: context_length, benchmarks
- `z-ai/glm-5` — changed: supported_parameters, benchmarks
- `z-ai/glm-5-turbo` — changed: benchmarks
- `z-ai/glm-5.1` — changed: benchmarks
- `z-ai/glm-5.2` — changed: top_provider, benchmarks
- `z-ai/glm-5.2:batch` — changed: benchmarks
- `z-ai/glm-5.3` — changed: benchmarks
- `z-ai/glm-5.3-flash` — changed: pricing, expiration_date, benchmarks
- `z-ai/glm-5.3-flash:batch` — changed: benchmarks
- `z-ai/glm-5.3:batch` — changed: benchmarks
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- **Mistral: Ministral 3 8B 2512 (batch)** (`mistralai/ministral-8b-2512:batch`)
- **Mistral: Mistral Large 3 2512 (batch)** (`mistralai/mistral-large-2512:batch`)
- **Mistral: Mistral Medium 3.1 (batch)** (`mistralai/mistral-medium-3.1:batch`)
- **Mistral: Mistral Small 4 (batch)** (`mistralai/mistral-small-2603:batch`)
...
- `minimax/minimax-m2` — changed: benchmarks
- `minimax/minimax-m2.1` — changed: benchmarks
- `minimax/minimax-m2.5` — changed: pricing, top_provider, benchmarks
- `minimax/minimax-m2.7` — changed: benchmarks
- `minimax/minimax-m3` — changed: benchmarks
- `minimax/minimax-m3:batch` — changed: benchmarks
- `mistralai/codestral-2508` — changed: benchmarks
...
- `mistralai/mistral-medium-3` — changed: benchmarks
- `mistralai/mistral-medium-3.1` — changed: benchmarks
- `mistralai/mistral-nemo` — changed: architecture
- `mistralai/mistral-small-3.2-24b-instruct` — changed: benchmarks
- `moonshotai/kimi-k2` — changed: benchmarks
...
- `moonshotai/kimi-k3` — changed: benchmarks
- `moonshotai/kimi-k3:batch` — changed: benchmarks
- `nex-agi/nex-n2.5-mini:free` — changed: architecture
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `openai/gpt-4.1` — changed: benchmarks
- `openai/gpt-4.1-mini` — changed: benchmarks
...
- `openai/o4-mini:batch` — changed: benchmarks
- `qwen/qwen3-235b-a22b` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: pricing, benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-30b-a3b` — changed: benchmarks
...
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: benchmarks
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3.5-122b-a10b` — changed: pricing, top_provider
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `qwen/qwen3.8-flash` — changed: supported_parameters
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: top_provider, benchmarks
- `thinkingmachines/inkling:batch` — changed: benchmarks
- `thinkingmachines/inkling:free` — changed: benchmarks
- `upstage/solar-pro4` — changed: benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
...
- `z-ai/glm-5.2` — changed: benchmarks
- `z-ai/glm-5.2:batch` — changed: benchmarks
- `z-ai/glm-5.3-flash` — changed: pricing, expiration_date
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- `minimax/minimax-m2.5` — changed: benchmarks
- `minimax/minimax-m2.7` — changed: benchmarks
- `minimax/minimax-m2.7:free` — changed: benchmarks
- `minimax/minimax-m3` — changed: benchmarks
- `minimax/minimax-m3:batch` — changed: benchmarks
- `minimax/minimax-m3:free` — changed: benchmarks
- `mistralai/codestral-2508` — changed: benchmarks
- `mistralai/ministral-14b-2512` — changed: benchmarks
- `mistralai/ministral-3b-2512` — changed: benchmarks
- `mistralai/ministral-8b-2512` — changed: benchmarks
...
- `deepseek/deepseek-v4-flash-vision-exp` — changed: pricing
- `deepseek/deepseek-v4-pro` — changed: pricing, benchmarks
- `deepseek/deepseek-v4-pro-0813` — changed: pricing, benchmarks
- `deepseek/deepseek-v4-pro-0813:batch` — changed: benchmarks
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-flash:batch` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
- `google/gemini-2.5-pro:batch` — changed: benchmarks
...
- `google/gemini-3.1-pro-preview:batch` — changed: benchmarks
- `google/gemini-3.5-flash` — changed: benchmarks
- `google/gemini-3.5-flash-lite` — changed: benchmarks
- `google/gemini-3.5-flash-lite:batch` — changed: benchmarks
- `google/gemini-3.5-flash:batch` — changed: benchmarks
- `google/gemini-3.6-flash` — changed: benchmarks
- `google/gemini-3.6-flash:batch` — changed: benchmarks
- `google/gemini-3.7-flash` — changed: benchmarks
...
- `google/gemma-4-31b-it:batch` — changed: benchmarks
- `google/gemma-4-31b-it:free` — changed: benchmarks
- `ibm-granite/granite-4.2-8b` — changed: benchmarks
- `inception/mercury-2` — changed: benchmarks
- `inclusionai/ling-3.0-flash` — changed: name, benchmarks
- `inclusionai/ling-3.0-flash-fin` — changed: name
- `inclusionai/ling-3.0-flash-fin:free` — changed: name
...
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
- `meta/muse-spark-1.3` — changed: benchmarks, reasoning
- `meta/muse-spark-1.3-contributor` — changed: reasoning
- `minimax/minimax-m2` — changed: benchmarks
- `minimax/minimax-m2.1` — changed: benchmarks
- `minimax/minimax-m2.5` — changed: benchmarks
- `minimax/minimax-m2.7` — changed: benchmarks
...
- `mistralai/mistral-medium-3-5:batch` — changed: benchmarks
- `mistralai/mistral-medium-3.1` — changed: benchmarks
...
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `nvidia/nemotron-3.5-lightning` — changed: benchmarks
- `nvidia/nemotron-3.5-lightning:free` — changed: benchmarks
- `openai/gpt-4` — changed: top_provider
- `openai/gpt-4.1` — changed: benchmarks
- `openai/gpt-4.1-mini` — changed: benchmarks
- `openai/gpt-4.1-mini:batch` — changed: benchmarks
- `openai/gpt-4.1-nano` — changed: benchmarks
...
- `openai/gpt-5.4-mini:batch` — changed: benchmarks
- `openai/gpt-5.4-nano` — changed: benchmarks
- `openai/gpt-5.4-nano:batch` — changed: benchmarks
- `openai/gpt-5.4:batch` — changed: benchmarks
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-5.5:batch` — changed: benchmarks
- `openai/gpt-5.6-luna` — changed: benchmarks
- `openai/gpt-5.6-luna:batch` — changed: benchmarks
- `openai/gpt-5.6-sol` — changed: benchmarks
- `openai/gpt-5.6-sol:batch` — changed: benchmarks
- `openai/gpt-5.6-terra` — changed: benchmarks
- `openai/gpt-5.6-terra:batch` — changed: benchmarks
- `openai/gpt-oss-120b` — changed: benchmarks
- `openai/gpt-oss-120b:batch` — changed: benchmarks
- `openai/gpt-oss-20b` — changed: benchmarks
- `openai/gpt-oss-20b:batch` — changed: benchmarks
...
- `qwen/qwen3.5-35b-a3b` — changed: pricing, top_provider, benchmarks
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-9b` — changed: benchmarks
- `qwen/qwen3.5-9b:batch` — changed: benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
...
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `qwen/qwen3.8-2.4t-a95b` — changed: benchmarks
- `qwen/qwen3.8-2.4t-a95b:batch` — changed: benchmarks
...
- `thinkingmachines/inkling-small:batch` — changed: benchmarks
- `thinkingmachines/inkling-small:free` — changed: benchmarks
- `thinkingmachines/inkling:batch` — changed: benchmarks
- `thinkingmachines/inkling:free` — changed: benchmarks
- `upstage/solar-pro-3` — changed: supported_parameters, benchmarks
- `upstage/solar-pro4` — changed: supported_parameters, benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.3:batch` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
...
- `arcee-ai/trinity-large-thinking` — changed: benchmarks
- `deepseek/deepseek-chat` — changed: pricing, top_provider, benchmarks
- `deepseek/deepseek-chat-v3.1` — changed: pricing, top_provider, benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-v3.1-terminus` — changed: benchmarks
- `deepseek/deepseek-v3.2` — changed: benchmarks
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
...
- `deepseek/deepseek-v4-flash-0731` — changed: benchmarks
- `deepseek/deepseek-v4-flash-0731:batch` — changed: benchmarks
- `deepseek/deepseek-v4-flash-vision-exp` — changed: supported_parameters
- `deepseek/deepseek-v4-pro` — changed: benchmarks
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-flash-image` — changed: benchmarks
- `google/gemini-2.5-flash:batch` — changed: benchmarks
...
- `google/gemini-3.8-flash` — changed: benchmarks
- `google/gemini-3.8-flash:batch` — changed: benchmarks
- `ibm-granite/granite-4.2-8b` — changed: supported_parameters
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
...
- `mistralai/mistral-large-2512` — changed: benchmarks
- `mistralai/mistral-medium-3` — changed: benchmarks
- `mistralai/mistral-medium-3-5:batch` — changed: context_length, top_provider
- `mistralai/mistral-medium-3.1` — changed: benchmarks
- `mistralai/mistral-small-3.2-24b-instruct` — changed: benchmarks
- `moonshotai/kimi-k2` — changed: benchmarks
- `moonshotai/kimi-k2-0905` — changed: benchmarks
...
- `qwen/qwen3-14b` — changed: pricing, top_provider
- `qwen/qwen3-235b-a22b` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-30b-a3b` — changed: benchmarks
...
- `thinkingmachines/inkling:batch` — changed: benchmarks
- `thinkingmachines/inkling:free` — changed: benchmarks
- `undi95/remm-slerp-l2-13b` — changed: pricing, top_provider
- `upstage/solar-pro4` — changed: benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
...
- `z-ai/glm-4.6` — changed: benchmarks
- `z-ai/glm-4.7` — changed: benchmarks
- `z-ai/glm-4.7-flash` — changed: expiration_date, benchmarks
- `z-ai/glm-5` — changed: benchmarks
- `z-ai/glm-5-turbo` — changed: benchmarks
- `z-ai/glm-5.1` — changed: benchmarks
- `z-ai/glm-5.2` — changed: benchmarks
- `z-ai/glm-5.2:free` — changed: benchmarks
- `z-ai/glm-5.3` — changed: pricing, top_provider, expiration_date
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- **NVIDIA: Nemotron 3 Ultra (batch)** (`nvidia/nemotron-3-ultra-550b-a55b:batch`)

### Updated

- `~anthropic/claude-haiku-latest` — changed: top_provider
- `~anthropic/claude-opus-latest` — changed: top_provider
- `~google/gemini-flash-latest` — changed: alias_target
- `~z-ai/glm-flash-latest` — changed: top_provider, expiration_date
- `~z-ai/glm-latest` — changed: pricing
- `amazon/nova-premier-v1` — changed: benchmarks
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: benchmarks
...
- `google/gemini-3-flash-preview` — changed: benchmarks
- `google/gemini-3-flash-preview:batch` — changed: benchmarks
- `google/gemini-3-pro-image` — changed: top_provider
- `google/gemini-3-pro-image-preview` — changed: benchmarks
- `google/gemini-3.1-flash-image-preview` — changed: benchmarks
- `google/gemini-3.1-flash-lite-preview` — changed: benchmarks
- `google/gemini-3.1-pro-preview` — changed: benchmarks
...
- `google/gemini-3.6-flash:batch` — changed: benchmarks
- `google/gemini-3.7-flash` — changed: benchmarks
- `google/gemini-3.7-flash:batch` — changed: pricing, benchmarks
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-3.3-70b-instruct` — changed: pricing, top_provider
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-glimmer-30b` — changed: pricing, top_provider
- `meta/muse-spark-1.1` — changed: benchmarks
...
- `moonshotai/kimi-k3:batch` — changed: benchmarks
- `nex-agi/nex-n2-pro` — changed: benchmarks
- `nvidia/nemotron-3-nano-30b-a3b` — changed: pricing, top_provider
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: pricing, top_provider, benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `openai/gpt-4.1` — changed: benchmarks
- `openai/gpt-4.1-mini` — changed: benchmarks
...
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `qwen/qwen3.8-2.4t-a95b` — changed: pricing, top_provider
- `qwen/qwen3.8-max` — changed: benchmarks
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: benchmarks
...
- `~anthropic/claude-fable-latest` — changed: alias_target, pricing, top_provider, supported_parameters, default_parameters
- `~z-ai/glm-latest` — changed: supported_parameters
- `amazon/nova-premier-v1` — changed: benchmarks
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-fable-5:batch` — changed: benchmarks
...
- `deepseek/deepseek-v4-flash-0731:batch` — changed: benchmarks
- `deepseek/deepseek-v4-flash-vision-exp` — changed: supported_parameters
- `deepseek/deepseek-v4-pro` — changed: pricing, top_provider, benchmarks
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-flash:batch` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
- `google/gemini-2.5-pro:batch` — changed: benchmarks
...
- `google/gemini-3.7-flash` — changed: benchmarks
- `google/gemini-3.7-flash:batch` — changed: benchmarks
- `gryphe/mythomax-l2-13b` — changed: pricing, top_provider
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: pricing, top_provider, benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
- `minimax/minimax-m2` — changed: benchmarks
- `minimax/minimax-m2.1` — changed: benchmarks
...
- `moonshotai/kimi-k3` — changed: benchmarks
- `moonshotai/kimi-k3:batch` — changed: benchmarks
- `nex-agi/nex-n2-mini` — changed: expiration_date
- `nex-agi/nex-n2-pro` — changed: expiration_date, benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: pricing, top_provider, benchmarks
...
- `qwen/qwen3-30b-a3b` — changed: benchmarks
- `qwen/qwen3-30b-a3b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-32b` — changed: supported_parameters
- `qwen/qwen3-coder` — changed: benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: benchmarks
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
...
- `qwen/qwen3.7-plus` — changed: benchmarks
- `qwen/qwen3.8-2.4t-a95b` — changed: pricing, top_provider
- `qwen/qwen3.8-2.4t-a95b:batch` — changed: pricing
- `qwen/qwen3.8-flash` — changed: hugging_face_id
- `qwen/qwen3.8-max` — changed: benchmarks
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: benchmarks
...
- `z-ai/glm-5.2` — changed: pricing, top_provider, benchmarks
- `z-ai/glm-5.2:free` — changed: benchmarks
- `z-ai/glm-5.3` — changed: supported_parameters
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- **Google: Gemma 4 31B (batch)** (`google/gemma-4-31b-it:batch`)
...
- **Thinking Machines: Inkling Small (batch)** (`thinkingmachines/inkling-small:batch`)
...
- `~google/gemini-flash-latest` — changed: pricing
- `~z-ai/glm-latest` — changed: context_length, pricing, top_provider, supported_parameters, expiration_date
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-fable-5:batch` — changed: benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
...
- `google/gemini-3.6-flash` — changed: benchmarks
- `google/gemini-3.6-flash:batch` — changed: benchmarks
- `google/gemini-3.7-flash` — changed: pricing, benchmarks
- `google/gemini-3.7-flash:batch` — changed: benchmarks
- `google/gemma-3-27b-it` — changed: context_length
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta/muse-glimmer-30b` — changed: pricing, top_provider
- `meta/muse-spark-1.1` — changed: benchmarks
...
- `mistralai/mistral-medium-3.1` — changed: benchmarks
- `mistralai/mistral-medium-3.1:batch` — changed: benchmarks
- `mistralai/voxtral-small-24b-2507` — changed: context_length, top_provider
- `moonshotai/kimi-k2` — changed: benchmarks
- `moonshotai/kimi-k2-thinking` — changed: benchmarks
- `moonshotai/kimi-k2.5` — changed: benchmarks
- `moonshotai/kimi-k2.6` — changed: benchmarks
...
- `openai/gpt-4.1` — changed: benchmarks
- `openai/gpt-4.1-mini` — changed: benchmarks
- `openai/gpt-4.1-nano` — changed: pricing, top_provider, benchmarks
- `openai/gpt-4o` — changed: benchmarks
- `openai/gpt-5` — changed: benchmarks
- `openai/gpt-5-image` — changed: benchmarks
- `openai/gpt-5-image-mini` — changed: benchmarks
...
- `qwen/qwen3-coder` — changed: benchmarks
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3-vl-30b-a3b-instruct` — changed: pricing, top_provider
- `qwen/qwen3.5-122b-a10b` — changed: pricing, top_provider
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-plus` — changed: benchmarks
...
- `z-ai/glm-5.2` — changed: benchmarks
- `z-ai/glm-5.2:free` — changed: benchmarks
- `z-ai/glm-5.3` — changed: context_length, supported_parameters
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- **Mistral: Mistral Large 3 2512 (batch)** (`mistralai/mistral-large-2512:batch`)
- **Mistral: Mistral Medium 3.1 (batch)** (`mistralai/mistral-medium-3.1:batch`)
- **Mistral: Mistral Medium 3.5 (batch)** (`mistralai/mistral-medium-3-5:batch`)
- **Mistral: Mistral Small 4 (batch)** (`mistralai/mistral-small-2603:batch`)
...
- **MoonshotAI: Kimi K2.7 Code (batch)** (`moonshotai/kimi-k2.7-code:batch`)
...
- **OpenAI: GPT-5 Codex (batch)** (`openai/gpt-5-codex:batch`)
...
- **OpenAI: o1 (batch)** (`openai/o1:batch`)
- **OpenAI: o1-pro (batch)** (`openai/o1-pro:batch`)
- **OpenAI: o3 (batch)** (`openai/o3:batch`)
- **OpenAI: o3 Mini (batch)** (`openai/o3-mini:batch`)
- **OpenAI: o3 Mini High (batch)** (`openai/o3-mini-high:batch`)
- **OpenAI: o3 Pro (batch)** (`openai/o3-pro:batch`)
- **OpenAI: o4 Mini (batch)** (`openai/o4-mini:batch`)
- **OpenAI: o4 Mini High (batch)** (`openai/o4-mini-high:batch`)
...
- `google/gemini-3.7-flash:batch` — changed: benchmarks
- `inception/mercury-2` — changed: benchmarks
- `kwaipilot/kat-coder-pro-v2.5` — changed: context_length, supported_parameters
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
...
- `mistralai/mistral-small-3.2-24b-instruct` — changed: benchmarks
- `moonshotai/kimi-k2-thinking` — changed: benchmarks
- `moonshotai/kimi-k2.5` — changed: pricing, expiration_date, benchmarks
- `moonshotai/kimi-k2.6` — changed: benchmarks
- `moonshotai/kimi-k2.7-code` — changed: pricing, benchmarks
- `moonshotai/kimi-k3` — changed: benchmarks
- `nex-agi/nex-n2-pro` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: context_length, pricing, top_provider, benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:batch` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `nvidia/nemotron-3.5-lightning` — changed: pricing, top_provider
- `openai/gpt-4.1` — changed: benchmarks
...
- `openai/o3` — changed: benchmarks
- `openai/o4-mini` — changed: benchmarks
- `openrouter/auto` — changed: description, default_parameters
- `qwen/qwen3-235b-a22b` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-30b-a3b` — changed: benchmarks
...
- `qwen/qwen3.8-flash` — changed: pricing
- `qwen/qwen3.8-max` — changed: benchmarks
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: benchmarks
...
- `z-ai/glm-5.2` — changed: benchmarks
- `z-ai/glm-5.2:free` — changed: benchmarks
- `z-ai/glm-5.3` — changed: hugging_face_id
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- `qwen/qwen3.8-max` — changed: benchmarks
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: pricing, benchmarks
- `thinkingmachines/inkling` — changed: benchmarks
- `thinkingmachines/inkling:batch` — changed: benchmarks
- `thinkingmachines/inkling:free` — changed: benchmarks
- `upstage/solar-pro4` — changed: benchmarks
...
- `~x-ai/grok-latest` — changed: top_provider, supported_parameters
- `aion-labs/aion-rp-llama-3.1-8b` — changed: top_provider
- `allenai/olmo-3-32b-think` — changed: top_provider
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-fable-5:batch` — changed: benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
- `anthropic/claude-haiku-4.5:batch` — changed: benchmarks
...
- `anthropic/claude-sonnet-5` — changed: benchmarks
- `anthropic/claude-sonnet-5:batch` — changed: benchmarks
- `arcee-ai/trinity-large-thinking` — changed: top_provider, benchmarks
- `bytedance-seed/seed-2-1-turbo` — changed: top_provider
- `deepseek/deepseek-chat` — changed: benchmarks
- `deepseek/deepseek-chat-v3-0324` — changed: top_provider
- `deepseek/deepseek-chat-v3.1` — changed: top_provider, benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-r1-distill-llama-70b` — changed: top_provider
- `deepseek/deepseek-v3.1-terminus` — changed: benchmarks
- `deepseek/deepseek-v3.2` — changed: top_provider, benchmarks
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
- `deepseek/deepseek-v4-flash` — changed: benchmarks
- `deepseek/deepseek-v4-flash-0731` — changed: pricing, top_provider, benchmarks
- `deepseek/deepseek-v4-pro` — changed: benchmarks
- `deepseek/deepseek-v4-pro-0813` — changed: top_provider
- `dots-studio/dots-3-note-preview:free` — changed: top_provider
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-flash:batch` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
- `google/gemini-2.5-pro:batch` — changed: benchmarks
...
- `google/gemini-3-flash-preview:batch` — changed: benchmarks
- `google/gemini-3-pro-image` — changed: top_provider
- `google/gemini-3.1-flash-image-preview` — changed: top_provider
...
- `google/gemini-3.7-flash` — changed: benchmarks
- `google/gemini-3.7-flash:batch` — changed: benchmarks
- `google/gemma-3-27b-it` — changed: top_provider
- `google/gemma-4-31b-it` — changed: top_provider
- `gryphe/mythomax-l2-13b` — changed: top_provider
- `ibm-granite/granite-4.0-h-micro` — changed: top_provider
- `ibm-granite/granite-4.1-8b` — changed: top_provider
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-3.1-8b-instruct` — changed: top_provider
- `meta-llama/llama-3.2-1b-instruct` — changed: top_provider
- `meta-llama/llama-3.2-3b-instruct` — changed: top_provider
- `meta-llama/llama-3.3-70b-instruct` — changed: pricing, top_provider
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: pricing, top_provider
- `meta-llama/llama-guard-4-12b` — changed: context_length
- `meta/muse-glimmer-30b` — changed: top_provider
- `meta/muse-spark-1.1` — changed: top_provider, benchmarks
- `meta/muse-spark-1.2` — changed: top_provider, benchmarks
- `meta/muse-spark-1.2-contributor` — changed: top_provider
- `microsoft/phi-4` — changed: top_provider
- `minimax/minimax-01` — changed: top_provider
- `minimax/minimax-m2.1` — changed: benchmarks
- `minimax/minimax-m2.5` — changed: benchmarks
- `minimax/minimax-m2.7` — changed: top_provider, benchmarks
- `minimax/minimax-m3` — changed: benchmarks
- `minimax/minimax-m3:batch` — changed: top_provider, benchmarks
- `mistralai/codestral-2508` — changed: top_provider
- `mistralai/devstral-2512` — changed: top_provider
- `mistralai/ministral-14b-2512` — changed: top_provider
- `mistralai/ministral-3b-2512` — changed: top_provider
- `mistralai/ministral-8b` — changed: top_provider
- `mistralai/ministral-8b-2512` — changed: top_provider
- `mistralai/mistral-large` — changed: top_provider
- `mistralai/mistral-large-2407` — changed: top_provider
- `mistralai/mistral-large-2512` — changed: top_provider, benchmarks
- `mistralai/mistral-medium-3` — changed: top_provider
- `mistralai/mistral-medium-3-5` — changed: top_provider
- `mistralai/mistral-medium-3.1` — changed: top_provider, benchmarks
- `mistralai/mistral-saba` — changed: top_provider
- `mistralai/mistral-small-2603` — changed: top_provider
- `mistralai/mistral-small-3.1-24b-instruct` — changed: top_provider
- `mistralai/mixtral-8x22b-instruct` — changed: top_provider
- `mistralai/voxtral-small-24b-2507` — changed: top_provider
- `moonshotai/kimi-k2` — changed: benchmarks
- `moonshotai/kimi-k2.5` — changed: top_provider, benchmarks
- `moonshotai/kimi-k2.6` — changed: top_provider, benchmarks
- `moonshotai/kimi-k2.7-code` — changed: top_provider, benchmarks
- `moonshotai/kimi-k2.7-code:batch` — changed: top_provider, benchmarks
- `moonshotai/kimi-k3` — changed: top_provider, benchmarks
- `nex-agi/nex-n2-mini` — changed: top_provider
- `nex-agi/nex-n2-pro` — changed: top_provider, benchmarks
- `nousresearch/hermes-4-405b` — changed: top_provider
- `nousresearch/hermes-4-70b` — changed: top_provider
- `nvidia/nemotron-3-nano-30b-a3b` — changed: top_provider
- `nvidia/nemotron-3-super-120b-a12b:free` — changed: top_provider
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: top_provider, benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:batch` — changed: top_provider, benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `openai/gpt-3.5-turbo-0613` — changed: top_provider
- `openai/gpt-3.5-turbo-instruct` — changed: top_provider
- `openai/gpt-4.1` — changed: benchmarks
- `openai/gpt-4.1-mini` — changed: benchmarks
- `openai/gpt-4.1-mini:batch` — changed: benchmarks
- `openai/gpt-4.1:batch` — changed: benchmarks
...
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-5.5:batch` — changed: benchmarks
- `openai/gpt-oss-120b` — changed: top_provider
- `openai/gpt-oss-20b` — changed: top_provider
- `perplexity/sonar` — changed: top_provider
- `perplexity/sonar-deep-research` — changed: top_provider
- `perplexity/sonar-reasoning-pro` — changed: top_provider
- `qwen/qwen-2.5-7b-instruct` — changed: top_provider
- `qwen/qwen-2.5-coder-32b-instruct` — changed: top_provider
- `qwen/qwen2.5-vl-72b-instruct` — changed: pricing, top_provider
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: top_provider
- `qwen/qwen3-30b-a3b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: top_provider, benchmarks
- `qwen/qwen3-coder-next` — changed: top_provider
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3-next-80b-a3b-instruct` — changed: top_provider
- `qwen/qwen3.5-122b-a10b` — changed: top_provider
- `qwen/qwen3.5-35b-a3b` — changed: top_provider
- `qwen/qwen3.5-397b-a17b` — changed: top_provider, benchmarks
- `qwen/qwen3.5-9b` — changed: top_provider
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-35b-a3b` — changed: top_provider
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `qwen/qwen3.8-27b` — changed: pricing, top_provider
- `qwen/qwen3.8-max` — changed: benchmarks
- `rekaai/reka-edge` — changed: top_provider
- `rekaai/reka-flash-3` — changed: top_provider
- `sao10k/l3-lunaris-8b` — changed: top_provider
- `stepfun/step-3.7-flash` — changed: top_provider, benchmarks
- `tencent/hunyuan-a13b-instruct` — changed: top_provider
- `tencent/hy3` — changed: benchmarks
- `tencent/hy3-preview` — changed: top_provider
- `thedrummer/cydonia-24b-v4.1` — changed: top_provider
- `thedrummer/rocinante-12b` — changed: top_provider
- `thedrummer/skyfall-36b-v2` — changed: top_provider
- `thedrummer/unslopnemo-12b` — changed: top_provider
- `thinkingmachines/inkling` — changed: benchmarks
- `thinkingmachines/inkling:batch` — changed: top_provider, benchmarks
- `thinkingmachines/inkling:free` — changed: benchmarks
- `upstage/solar-pro-3` — changed: top_provider
- `upstage/solar-pro4` — changed: benchmarks
- `x-ai/grok-4.20` — changed: top_provider, benchmarks
- `x-ai/grok-4.20-multi-agent` — changed: top_provider
- `x-ai/grok-4.3` — changed: top_provider, benchmarks
- `x-ai/grok-4.5` — changed: top_provider, benchmarks
- `x-ai/grok-4.6` — changed: top_provider, supported_parameters, benchmarks
- `x-ai/grok-build-0.1` — changed: top_provider
- `xiaomi/mimo-v2.5` — changed: benchmarks
- `xiaomi/mimo-v2.5-pro` — changed: benchmarks
- `z-ai/glm-4.5` — changed: benchmarks
- `z-ai/glm-4.5-air` — changed: benchmarks
...
- `z-ai/glm-5` — changed: benchmarks
- `z-ai/glm-5-turbo` — changed: benchmarks
- `z-ai/glm-5.1` — changed: top_provider, benchmarks
- `z-ai/glm-5.2` — changed: benchmarks
- `z-ai/glm-5.2:batch` — changed: top_provider, benchmarks
- `z-ai/glm-5.2:free` — changed: top_provider, benchmarks
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-5.5:batch` — changed: benchmarks
- `openai/gpt-oss-120b` — changed: pricing
- `openai/o3` — changed: benchmarks
- `openai/o3:batch` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-30b-a3b` — changed: pricing, top_provider, benchmarks
- `qwen/qwen3-coder` — changed: benchmarks
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3-next-80b-a3b-instruct` — changed: pricing, top_provider
- `qwen/qwen3.5-122b-a10b` — changed: top_provider
...
- **Mistral: Ministral 8B** (`mistralai/ministral-8b`)
- **Ox Alpha** (`stealth/ox-alpha`)
- **Tencent: Hy-MT2-1.8B** (`tencent/hy-mt2-1.8b`)
- **Tencent: Hy-MT2-30B-A3B** (`tencent/hy-mt2-30b-a3b`)
...
- `deepseek/deepseek-chat-v3.1` — changed: benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-v3.1-terminus` — changed: pricing, top_provider, benchmarks
- `deepseek/deepseek-v3.2` — changed: benchmarks
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
- `deepseek/deepseek-v4-flash` — changed: benchmarks
- `deepseek/deepseek-v4-flash-0731` — changed: benchmarks
...
- `z-ai/glm-5.1` — changed: benchmarks
- `z-ai/glm-5.2` — changed: benchmarks
- `z-ai/glm-5.2:batch` — changed: context_length, top_provider, benchmarks
- `z-ai/glm-5.2:free` — changed: benchmarks
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- `minimax/minimax-m2.7` — changed: benchmarks
- `minimax/minimax-m3` — changed: benchmarks
- `minimax/minimax-m3:batch` — changed: pricing, benchmarks
- `mistralai/codestral-2508` — changed: benchmarks
- `mistralai/ministral-14b-2512` — changed: benchmarks
- `mistralai/ministral-3b-2512` — changed: benchmarks
- `mistralai/ministral-8b-2512` — changed: benchmarks
...
- `moonshotai/kimi-k2.6` — changed: benchmarks
- `moonshotai/kimi-k2.7-code` — changed: benchmarks
- `moonshotai/kimi-k2.7-code:batch` — changed: pricing, benchmarks
- `moonshotai/kimi-k3` — changed: benchmarks
- `nex-agi/nex-n2-pro` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:batch` — changed: pricing, benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `nvidia/nemotron-nano-12b-v2-vl:free` — changed: expiration_date
- `openai/gpt-4.1` — changed: benchmarks
- `openai/gpt-4.1-mini` — changed: benchmarks
- `openai/gpt-4.1-mini:batch` — changed: benchmarks
- `openai/gpt-4.1-nano` — changed: benchmarks
...
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: benchmarks
- `thinkingmachines/inkling:batch` — changed: pricing, benchmarks
- `upstage/solar-pro4` — changed: benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
...
- `z-ai/glm-5.1` — changed: benchmarks
- `z-ai/glm-5.2` — changed: pricing, benchmarks
- `z-ai/glm-5.2:batch` — changed: pricing, benchmarks
- `z-ai/glm-5.2:free` — changed: context_length, top_provider, supported_parameters, benchmarks
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- `deepseek/deepseek-v4-flash` — changed: pricing, benchmarks
- `deepseek/deepseek-v4-flash-0731` — changed: benchmarks
- `deepseek/deepseek-v4-pro` — changed: name, pricing, top_provider, benchmarks
- `deepseek/deepseek-v4-pro-0813` — changed: pricing
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-flash:batch` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
...
- `openai/gpt-4o:batch` — changed: benchmarks
- `openai/gpt-5` — changed: benchmarks
- `openai/gpt-5-codex:batch` — changed: benchmarks
- `openai/gpt-5-mini` — changed: benchmarks
- `openai/gpt-5-mini:batch` — changed: benchmarks
- `openai/gpt-5-nano` — changed: benchmarks
- `openai/gpt-5-nano:batch` — changed: benchmarks
...
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: benchmarks
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3-vl-235b-a22b-instruct` — changed: pricing
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-35b-a3b` — changed: pricing
- `qwen/qwen3.6-plus` — changed: benchmarks
...
- `deepseek/deepseek-chat-v3.1` — changed: benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-v3.1-terminus` — changed: expiration_date, benchmarks
- `deepseek/deepseek-v3.2` — changed: benchmarks
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
- `deepseek/deepseek-v4-flash` — changed: pricing, top_provider, supported_parameters, benchmarks
- `deepseek/deepseek-v4-flash-0731` — changed: benchmarks
- `deepseek/deepseek-v4-pro` — changed: supported_parameters, benchmarks
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-flash-image` — changed: benchmarks
- `google/gemini-2.5-flash:batch` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
...
- `google/gemini-3.6-flash` — changed: benchmarks
- `google/gemini-3.6-flash:batch` — changed: benchmarks
- `google/gemini-3.7-flash` — changed: pricing
- `google/gemini-3.7-flash:batch` — changed: pricing
- `inception/mercury-2` — changed: benchmarks
- `liquid/lfm-2.5-2.6b:free` — changed: top_provider
- `meta-llama/llama-4-maverick` — changed: pricing, top_provider, benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
...
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-5.5:batch` — changed: benchmarks
- `openai/gpt-5.6-luna` — changed: pricing
- `openai/gpt-5.6-luna-pro` — changed: pricing
- `openai/gpt-5.6-terra` — changed: pricing
- `openai/gpt-5.6-terra-pro` — changed: pricing
- `openai/gpt-oss-120b` — changed: benchmarks
- `openai/gpt-oss-20b` — changed: benchmarks
- `openai/o3` — changed: benchmarks
- `openai/o3:batch` — changed: benchmarks
...
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `qwen/qwen3.8-2.4t-a95b` — changed: context_length
- `qwen/qwen3.8-max` — changed: benchmarks
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: benchmarks
...
- `z-ai/glm-4.7` — changed: benchmarks
- `z-ai/glm-4.7-flash` — changed: benchmarks
- `z-ai/glm-5` — changed: pricing, top_provider, benchmarks
- `z-ai/glm-5-turbo` — changed: benchmarks
- `z-ai/glm-5.1` — changed: pricing, top_provider, benchmarks
- `z-ai/glm-5.2` — changed: pricing, top_provider, benchmarks
- `z-ai/glm-5.2:batch` — changed: benchmarks
...
- `~google/gemini-flash-latest` — changed: alias_target, pricing, default_parameters, reasoning
- `amazon/nova-premier-v1` — changed: benchmarks
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthracite-org/magnum-v4-72b` — changed: context_length, top_provider
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-fable-5:batch` — changed: benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
- `anthropic/claude-haiku-4.5:batch` — changed: benchmarks
...
- `deepseek/deepseek-chat` — changed: benchmarks
- `deepseek/deepseek-chat-v3.1` — changed: benchmarks
- `deepseek/deepseek-r1` — changed: context_length, supported_parameters
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-v3.1-terminus` — changed: benchmarks
- `deepseek/deepseek-v3.2` — changed: benchmarks
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
...
- `deepseek/deepseek-v4-flash-0731` — changed: pricing, top_provider, benchmarks
- `deepseek/deepseek-v4-pro` — changed: benchmarks
- `deepseek/deepseek-v4-pro-0813` — changed: hugging_face_id, supported_parameters, benchmarks
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-flash-image` — changed: benchmarks
- `google/gemini-2.5-flash:batch` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
...
- `google/gemini-3.5-flash` — changed: benchmarks
- `google/gemini-3.5-flash:batch` — changed: benchmarks
- `google/gemini-3.6-flash` — changed: pricing, benchmarks
- `google/gemini-3.6-flash:batch` — changed: pricing, benchmarks
- `inception/mercury-2` — changed: benchmarks
- `kwaipilot/kat-coder-air-v2.5` — changed: supported_parameters
- `kwaipilot/kat-coder-pro-v2.5` — changed: supported_parameters
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
...
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `qwen/qwen3.8-2.4t-a95b` — changed: context_length, pricing, top_provider
- `qwen/qwen3.8-max` — changed: benchmarks
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: benchmarks
- `thinkingmachines/inkling:batch` — changed: benchmarks
- `upstage/solar-pro4` — changed: description, benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
- `x-ai/grok-4.6` — changed: benchmarks
...
- **ByteDance Seed: Seed 2.1 Turbo** (`bytedance-seed/seed-2-1-turbo`)
...
- `~deepseek/deepseek-v4-flash-latest` — changed: pricing, top_provider
- `~x-ai/grok-latest` — changed: alias_target, pricing, default_parameters, reasoning
- `amazon/nova-premier-v1` — changed: benchmarks
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-fable-5:batch` — changed: benchmarks
...
- `anthropic/claude-sonnet-5:batch` — changed: benchmarks
- `arcee-ai/trinity-large-thinking` — changed: benchmarks
- `bytedance-seed/seed-2.0-code` — changed: created
- `deepseek/deepseek-chat` — changed: benchmarks
- `deepseek/deepseek-chat-v3.1` — changed: benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-v3.1-terminus` — changed: benchmarks
...
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
- `deepseek/deepseek-v4-flash` — changed: benchmarks
- `deepseek/deepseek-v4-flash-0731` — changed: description, benchmarks
- `deepseek/deepseek-v4-pro` — changed: pricing, default_parameters, benchmarks
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-flash:batch` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
- `google/gemini-2.5-pro:batch` — changed: benchmarks
...
- `google/gemini-3.6-flash:batch` — changed: benchmarks
- `inception/mercury-2` — changed: benchmarks
- `inclusionai/ling-3.0-tiny:free` — changed: expiration_date
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
...
- `nvidia/nemotron-3-ultra-550b-a55b:batch` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `nvidia/nemotron-3.5-lightning` — changed: context_length, supported_parameters
...
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: benchmarks
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3.5-35b-a3b` — changed: pricing
- `qwen/qwen3.5-397b-a17b` — changed: pricing, top_provider, benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: benchmarks
...
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.5` — changed: description, default_parameters, benchmarks
- `xiaomi/mimo-v2.5` — changed: benchmarks
- `xiaomi/mimo-v2.5-pro` — changed: benchmarks
- `z-ai/glm-4.5` — changed: benchmarks
- `z-ai/glm-4.5-air` — changed: benchmarks
...
- **ByteDance Seed: Seed-2.0-Code** (`bytedance-seed/seed-2.0-code`)
- **LiquidAI: LFM2.5-2.6B (free)** (`liquid/lfm-2.5-2.6b:free`)
...
- `~deepseek/deepseek-v4-flash-latest` — changed: pricing, top_provider, supported_parameters
- `~moonshotai/kimi-latest` — changed: architecture
...
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
- `deepseek/deepseek-v4-flash` — changed: benchmarks
- `deepseek/deepseek-v4-flash-0731` — changed: supported_parameters, benchmarks
- `deepseek/deepseek-v4-pro` — changed: pricing, benchmarks
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-flash:batch` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
...
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-glimmer-30b` — changed: supported_parameters
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
- `minimax/minimax-m2` — changed: benchmarks
- `minimax/minimax-m2.1` — changed: benchmarks
...
- `moonshotai/kimi-k2.7-code` — changed: benchmarks
- `moonshotai/kimi-k2.7-code:batch` — changed: benchmarks
- `moonshotai/kimi-k3` — changed: architecture, benchmarks
- `nex-agi/nex-n2-pro` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:batch` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
...
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-5.5:batch` — changed: benchmarks
- `openai/gpt-oss-120b` — changed: pricing, benchmarks
- `openai/gpt-oss-20b` — changed: benchmarks
- `openai/gpt-oss-20b:free` — changed: benchmarks
- `openai/o4-mini` — changed: benchmarks
- `openai/o4-mini:batch` — changed: benchmarks
...
- **Upstage: Solar Pro 4** (`upstage/solar-pro4`)
...
- `google/gemini-3.6-flash:batch` — changed: benchmarks
- `inception/mercury-2` — changed: benchmarks
- `inclusionai/ling-3.0-tiny:free` — changed: hugging_face_id, default_parameters, benchmarks
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
- `meta/muse-spark-1.2` — changed: benchmarks
- `minimax/minimax-m2.1` — changed: benchmarks
...
- `openai/gpt-5.1:batch` — changed: benchmarks
- `openai/gpt-5.2` — changed: benchmarks
- `openai/gpt-5.2-chat` — changed: top_provider, supported_parameters, expiration_date
- `openai/gpt-5.2-codex` — changed: benchmarks
- `openai/gpt-5.2:batch` — changed: benchmarks
- `openai/gpt-5.3-codex` — changed: benchmarks
- `openai/gpt-5.4` — changed: benchmarks
...
- `qwen/qwen3-30b-a3b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-coder` — changed: benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: pricing, top_provider
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3-next-80b-a3b-thinking` — changed: top_provider
- `qwen/qwen3.5-397b-a17b` — changed: pricing, top_provider, benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
...
- **Anthropic: Claude Fable 5 (batch)** (`anthropic/claude-fable-5:batch`)
- **Anthropic: Claude Haiku 4.5 (batch)** (`anthropic/claude-haiku-4.5:batch`)
- **Anthropic: Claude Opus 4.1 (batch)** (`anthropic/claude-opus-4.1:batch`)
- **Anthropic: Claude Opus 4.5 (batch)** (`anthropic/claude-opus-4.5:batch`)
- **Anthropic: Claude Opus 4.6 (batch)** (`anthropic/claude-opus-4.6:batch`)
- **Anthropic: Claude Opus 4.7 (batch)** (`anthropic/claude-opus-4.7:batch`)
- **Anthropic: Claude Opus 4.8 (batch)** (`anthropic/claude-opus-4.8:batch`)
- **Anthropic: Claude Sonnet 4.5 (batch)** (`anthropic/claude-sonnet-4.5:batch`)
...
- **inclusionAI: Ling 3.0 Tiny (free)** (`inclusionai/ling-3.0-tiny:free`)
- **MiniMax: MiniMax M3 (batch)** (`minimax/minimax-m3:batch`)
- **MoonshotAI: Kimi K2.7 Code (batch)** (`moonshotai/kimi-k2.7-code:batch`)
- **NVIDIA: Nemotron 3 Ultra (batch)** (`nvidia/nemotron-3-ultra-550b-a55b:batch`)
- **OpenAI: GPT-3.5 Turbo (batch)** (`openai/gpt-3.5-turbo:batch`)
- **OpenAI: GPT-4 Turbo (batch)** (`openai/gpt-4-turbo:batch`)
...
- **OpenAI: o4 Mini (batch)** (`openai/o4-mini:batch`)
- **OpenAI: o4 Mini High (batch)** (`openai/o4-mini-high:batch`)
- **Thinking Machines: Inkling (batch)** (`thinkingmachines/inkling:batch`)
- **Z.ai: GLM 5.2 (batch)** (`z-ai/glm-5.2:batch`)
...
- `google/gemini-2.5-flash-image` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
- `google/gemini-3-flash-preview` — changed: top_provider, benchmarks
- `google/gemini-3-pro-image-preview` — changed: benchmarks
- `google/gemini-3.1-flash-image-preview` — changed: benchmarks
- `google/gemini-3.1-flash-lite-preview` — changed: benchmarks
- `google/gemini-3.1-pro-preview` — changed: benchmarks
...
- `inclusionai/ling-3.0-flash` — changed: context_length, pricing, top_provider, supported_parameters, benchmarks
- `inclusionai/ring-2.6-1t` — changed: benchmarks
- `kwaipilot/kat-coder-pro-v2` — changed: benchmarks
- `meta-llama/llama-3.1-8b-instruct` — changed: benchmarks
- `meta-llama/llama-3.3-70b-instruct` — changed: benchmarks
...
- `nvidia/nemotron-3-super-120b-a12b` — changed: pricing, top_provider, benchmarks
- `nvidia/nemotron-3-super-120b-a12b:free` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `openai/gpt-4.1` — changed: benchmarks
...
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3-next-80b-a3b-thinking` — changed: benchmarks
- `qwen/qwen3-vl-235b-a22b-thinking` — changed: pricing
- `qwen/qwen3.5-122b-a10b` — changed: pricing, top_provider, benchmarks
- `qwen/qwen3.5-35b-a3b` — changed: benchmarks
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-9b` — changed: benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-27b` — changed: pricing, top_provider, benchmarks
- `qwen/qwen3.6-35b-a3b` — changed: pricing, benchmarks
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `qwen/qwen3.8-max` — changed: benchmarks
...
- `deepseek/deepseek-v3.2` — changed: benchmarks
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
- `deepseek/deepseek-v4-flash` — changed: name, default_parameters, benchmarks
- `deepseek/deepseek-v4-pro` — changed: benchmarks
- `google/gemini-2.5-flash` — changed: pricing, benchmarks
- `google/gemini-2.5-flash-image` — changed: pricing
- `google/gemini-2.5-flash-lite` — changed: pricing
- `google/gemini-2.5-pro` — changed: benchmarks
- `google/gemini-3-flash-preview` — changed: pricing, benchmarks
- `google/gemini-3.1-flash-lite` — changed: pricing
- `google/gemini-3.1-flash-lite-preview` — changed: pricing, benchmarks
- `google/gemini-3.1-pro-preview` — changed: benchmarks
- `google/gemini-3.5-flash` — changed: pricing, benchmarks
- `google/gemini-3.5-flash-lite` — changed: pricing
- `google/gemini-3.6-flash` — changed: pricing, benchmarks
- `gryphe/mythomax-l2-13b` — changed: pricing
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-3.3-70b-instruct` — changed: pricing, top_provider
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
...
- `qwen/qwen3-30b-a3b` — changed: benchmarks
- `qwen/qwen3-coder` — changed: benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: pricing, top_provider, benchmarks
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3-next-80b-a3b-instruct` — changed: pricing, top_provider
- `qwen/qwen3-next-80b-a3b-thinking` — changed: top_provider
- `qwen/qwen3-vl-30b-a3b-instruct` — changed: pricing, top_provider
- `qwen/qwen3.5-122b-a10b` — changed: pricing
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-27b` — changed: pricing, top_provider
- `qwen/qwen3.6-plus` — changed: benchmarks
...
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-oss-120b` — changed: benchmarks
- `openai/gpt-oss-20b` — changed: pricing, benchmarks
- `openai/gpt-oss-20b:free` — changed: benchmarks
- `openai/o3` — changed: benchmarks
- `openai/o4-mini` — changed: benchmarks
- `poolside/laguna-s-2.1` — changed: supported_parameters, default_parameters
- `poolside/laguna-s-2.1:free` — changed: default_parameters
- `poolside/laguna-xs-2.1` — changed: default_parameters
- `poolside/laguna-xs-2.1:free` — changed: default_parameters
- `qwen/qwen3-235b-a22b` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-30b-a3b` — changed: benchmarks
...
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: top_provider, benchmarks
- `qwen/qwen3.7-plus` — changed: top_provider, benchmarks
- `sao10k/l3-lunaris-8b` — changed: supported_parameters
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
...
- `~anthropic/claude-fable-latest` — changed: pricing
- `~moonshotai/kimi-latest` — changed: top_provider
- `anthropic/claude-fable-5` — changed: pricing, benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
- `anthropic/claude-opus-4` — changed: benchmarks
- `anthropic/claude-opus-4.5` — changed: benchmarks
- `anthropic/claude-opus-4.6` — changed: benchmarks
...
- `google/gemini-3.6-flash` — changed: benchmarks
- `google/gemma-4-26b-a4b-it` — changed: pricing
- `google/gemma-4-31b-it` — changed: pricing
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
...
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-oss-120b` — changed: benchmarks
- `openai/gpt-oss-20b` — changed: pricing
- `openai/o3` — changed: benchmarks
- `openai/o4-mini` — changed: benchmarks
- `qwen/qwen-2.5-7b-instruct` — changed: supported_parameters
- `qwen/qwen-plus` — changed: supported_parameters
- `qwen/qwen-plus-2025-07-28` — changed: supported_parameters
- `qwen/qwen-plus-2025-07-28:thinking` — changed: pricing, supported_parameters
- `qwen/qwen3-235b-a22b` — changed: supported_parameters
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-30b-a3b-thinking-2507` — changed: pricing, supported_parameters
- `qwen/qwen3-8b` — changed: supported_parameters
- `qwen/qwen3-coder` — changed: benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: benchmarks
- `qwen/qwen3-coder-flash` — changed: supported_parameters
- `qwen/qwen3-coder-next` — changed: pricing, top_provider
- `qwen/qwen3-coder-plus` — changed: supported_parameters
- `qwen/qwen3-max` — changed: top_provider, supported_parameters, benchmarks
- `qwen/qwen3-max-thinking` — changed: top_provider, supported_parameters
- `qwen/qwen3-next-80b-a3b-thinking` — changed: pricing
- `qwen/qwen3-vl-235b-a22b-thinking` — changed: pricing
- `qwen/qwen3-vl-30b-a3b-thinking` — changed: pricing, supported_parameters
- `qwen/qwen3-vl-32b-instruct` — changed: supported_parameters
- `qwen/qwen3-vl-8b-thinking` — changed: pricing, supported_parameters
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-flash-02-23` — changed: supported_parameters
...
- `qwen/qwen3.6-max-preview` — changed: supported_parameters
- `qwen/qwen3.6-plus` — changed: supported_parameters, benchmarks
- `qwen/qwen3.7-max` — changed: pricing, supported_parameters, benchmarks
- `qwen/qwen3.7-plus` — changed: supported_parameters, benchmarks
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
...
- `~moonshotai/kimi-latest` — changed: top_provider, supported_parameters, default_parameters
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
- `anthropic/claude-opus-4` — changed: benchmarks
- `anthropic/claude-opus-4.1` — changed: benchmarks
...
- `google/gemini-3-flash-preview` — changed: benchmarks
- `google/gemini-3-pro-image-preview` — changed: benchmarks
- `google/gemini-3.1-flash-image-preview` — changed: context_length
- `google/gemini-3.1-flash-lite-preview` — changed: benchmarks
- `google/gemini-3.1-pro-preview` — changed: benchmarks
- `google/gemini-3.5-flash` — changed: benchmarks
- `google/gemini-3.6-flash` — changed: benchmarks
...
- `moonshotai/kimi-k2.6` — changed: benchmarks
- `moonshotai/kimi-k2.7-code` — changed: benchmarks
- `moonshotai/kimi-k3` — changed: hugging_face_id, supported_parameters, default_parameters, benchmarks
- `nex-agi/nex-n2-pro` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `openai/gpt-4.1` — changed: benchmarks
...
- `openai/gpt-5-nano` — changed: benchmarks
- `openai/gpt-5.1` — changed: benchmarks
- `openai/gpt-5.1-chat` — changed: pricing, top_provider, supported_parameters
...
- `deepseek/deepseek-v3.2` — changed: benchmarks
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
- `deepseek/deepseek-v4-flash` — changed: supported_parameters, benchmarks
- `deepseek/deepseek-v4-pro` — changed: benchmarks
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
- `google/gemini-3-flash-preview` — changed: benchmarks
...
- `google/gemini-3.6-flash` — changed: benchmarks
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-3.2-3b-instruct` — changed: pricing, top_provider
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
- `minimax/minimax-m2` — changed: benchmarks
...
- `openai/gpt-5-nano` — changed: benchmarks
- `openai/gpt-5.1` — changed: benchmarks
- `openai/gpt-5.1-codex` — changed: pricing, top_provider, benchmarks
- `openai/gpt-5.1-codex-max` — changed: top_provider
- `openai/gpt-5.1-codex-mini` — changed: pricing, top_provider, benchmarks
- `openai/gpt-5.2` — changed: benchmarks
- `openai/gpt-5.2-codex` — changed: top_provider, benchmarks
- `openai/gpt-5.3-codex` — changed: benchmarks
- `openai/gpt-5.4` — changed: benchmarks
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-oss-120b` — changed: benchmarks
...
- `anthropic/claude-sonnet-4.5` — changed: benchmarks
- `anthropic/claude-sonnet-4.6` — changed: benchmarks
- `anthropic/claude-sonnet-5` — changed: benchmarks, reasoning
- `arcee-ai/trinity-large-thinking` — changed: benchmarks
- `deepseek/deepseek-chat` — changed: benchmarks
- `deepseek/deepseek-chat-v3.1` — changed: benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
...
- `google/gemini-3.5-flash` — changed: benchmarks
- `google/gemini-3.6-flash` — changed: benchmarks
- `google/gemma-3-27b-it` — changed: pricing, top_provider
- `google/gemma-4-31b-it` — changed: pricing, top_provider
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
...
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-oss-120b` — changed: benchmarks
- `openai/gpt-oss-20b` — changed: pricing, top_provider, benchmarks
- `openai/gpt-oss-20b:free` — changed: benchmarks
- `openai/o3` — changed: benchmarks
- `openai/o4-mini` — changed: benchmarks
- `qwen/qwen3-235b-a22b` — changed: benchmarks
...
- `qwen/qwen3-30b-a3b` — changed: benchmarks
- `qwen/qwen3-30b-a3b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-coder` — changed: pricing, benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: benchmarks
- `qwen/qwen3-max` — changed: benchmarks
...
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: context_length, supported_parameters
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
- `xiaomi/mimo-v2.5` — changed: benchmarks
...
- `~google/gemini-flash-latest` — changed: pricing, knowledge_cutoff
- `amazon/nova-premier-v1` — changed: benchmarks
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthracite-org/magnum-v4-72b` — changed: context_length
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
- `anthropic/claude-opus-4` — changed: benchmarks
- `anthropic/claude-opus-4.1` — changed: benchmarks
...
- `anthropic/claude-sonnet-5` — changed: benchmarks
- `arcee-ai/trinity-large-thinking` — changed: benchmarks
- `baidu/ernie-4.5-vl-424b-a47b` — changed: context_length
- `deepseek/deepseek-chat` — changed: context_length, benchmarks
- `deepseek/deepseek-chat-v3.1` — changed: benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-r1-distill-llama-70b` — changed: context_length
- `deepseek/deepseek-v3.1-terminus` — changed: context_length, benchmarks
- `deepseek/deepseek-v3.2` — changed: benchmarks
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
- `deepseek/deepseek-v4-flash` — changed: benchmarks
- `deepseek/deepseek-v4-pro` — changed: benchmarks
...
- `google/gemini-2.5-pro` — changed: benchmarks
- `google/gemini-3-flash-preview` — changed: benchmarks
- `google/gemini-3-pro-image` — changed: context_length
- `google/gemini-3.1-flash-image-preview` — changed: top_provider, benchmarks
- `google/gemini-3.1-flash-lite-preview` — changed: benchmarks
- `google/gemini-3.1-pro-preview` — changed: benchmarks
- `google/gemini-3.1-pro-preview-customtools` — changed: context_length
- `google/gemini-3.5-flash` — changed: benchmarks
- `google/gemma-3-27b-it` — changed: context_length
- `gryphe/mythomax-l2-13b` — changed: context_length
- `inception/mercury-2` — changed: benchmarks
- `kwaipilot/kat-coder-pro-v2` — changed: context_length
- `meta-llama/llama-3.2-1b-instruct` — changed: context_length
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: context_length, benchmarks
- `meta-llama/llama-guard-4-12b` — changed: context_length
- `meta/muse-spark-1.1` — changed: benchmarks
- `microsoft/wizardlm-2-8x22b` — changed: context_length
- `minimax/minimax-m2` — changed: benchmarks
- `minimax/minimax-m2.1` — changed: benchmarks
- `minimax/minimax-m2.5` — changed: benchmarks
- `minimax/minimax-m2.7` — changed: benchmarks
- `minimax/minimax-m3` — changed: benchmarks
- `mistralai/codestral-2508` — changed: benchmarks
- `mistralai/ministral-14b-2512` — changed: supported_parameters, benchmarks
- `mistralai/ministral-3b-2512` — changed: supported_parameters, benchmarks
- `mistralai/ministral-8b-2512` — changed: benchmarks
- `mistralai/mistral-large-2512` — changed: benchmarks
- `mistralai/mistral-medium-3` — changed: benchmarks
- `mistralai/mistral-medium-3.1` — changed: benchmarks
...
- `nvidia/nemotron-3-super-120b-a12b:free` — changed: context_length
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: context_length, benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `openai/gpt-3.5-turbo-16k` — changed: top_provider
- `openai/gpt-4.1` — changed: benchmarks
- `openai/gpt-4.1-mini` — changed: benchmarks
...
- `openai/o3` — changed: benchmarks
- `openai/o4-mini` — changed: benchmarks
- `qwen/qwen-2.5-72b-instruct` — changed: context_length
- `qwen/qwen-2.5-7b-instruct` — changed: context_length
- `qwen/qwen-2.5-coder-32b-instruct` — changed: context_length
- `qwen/qwen2.5-vl-72b-instruct` — changed: context_length
- `qwen/qwen3-14b` — changed: context_length
- `qwen/qwen3-235b-a22b` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-30b-a3b` — changed: benchmarks
- `qwen/qwen3-30b-a3b-thinking-2507` — changed: context_length, benchmarks
- `qwen/qwen3-coder` — changed: context_length, benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: context_length, benchmarks
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3-next-80b-a3b-instruct` — changed: pricing, top_provider
- `qwen/qwen3-vl-235b-a22b-instruct` — changed: context_length
- `qwen/qwen3-vl-30b-a3b-thinking` — changed: context_length
- `qwen/qwen3-vl-32b-instruct` — changed: context_length
- `qwen/qwen3-vl-8b-instruct` — changed: context_length
- `qwen/qwen3-vl-8b-thinking` — changed: context_length
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `stepfun/step-3.7-flash` — changed: context_length, benchmarks
- `tencent/hy3` — changed: benchmarks
- `thinkingmachines/inkling` — changed: context_length
- `undi95/remm-slerp-l2-13b` — changed: top_provider
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
- `xiaomi/mimo-v2.5` — changed: context_length, benchmarks
- `xiaomi/mimo-v2.5-pro` — changed: context_length, benchmarks
- `z-ai/glm-4.5` — changed: benchmarks
- `z-ai/glm-4.5-air` — changed: benchmarks
- `z-ai/glm-4.6` — changed: context_length, benchmarks
- `z-ai/glm-4.7` — changed: context_length, benchmarks
- `z-ai/glm-4.7-flash` — changed: context_length, benchmarks
- `z-ai/glm-5` — changed: benchmarks
- `z-ai/glm-5-turbo` — changed: benchmarks
- `z-ai/glm-5.1` — changed: context_length, benchmarks
- `z-ai/glm-5.2` — changed: pricing, benchmarks
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- `qwen/qwen3.7-plus` — changed: benchmarks
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: pricing, top_provider, supported_parameters, benchmarks, reasoning
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
- `xiaomi/mimo-v2.5` — changed: benchmarks
...
- `~moonshotai/kimi-latest` — changed: reasoning
- `amazon/nova-premier-v1` — changed: benchmarks
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
...
- `moonshotai/kimi-k2.6` — changed: benchmarks
- `moonshotai/kimi-k2.7-code` — changed: benchmarks
- `moonshotai/kimi-k3` — changed: benchmarks, reasoning
- `nex-agi/nex-n2-pro` — changed: benchmarks
- `nvidia/nemotron-3-super-120b-a12b` — changed: pricing, top_provider
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
...
- `qwen/qwen3-235b-a22b` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: pricing, top_provider, benchmarks
- `qwen/qwen3-30b-a3b` — changed: benchmarks
- `qwen/qwen3-30b-a3b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-coder` — changed: benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: benchmarks
...
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `tencent/hy3:free` — changed: benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
- `xiaomi/mimo-v2.5` — changed: benchmarks
...
- `z-ai/glm-4.5-air` — changed: benchmarks
- `z-ai/glm-4.6` — changed: benchmarks
- `z-ai/glm-4.7` — changed: default_parameters, benchmarks
- `z-ai/glm-4.7-flash` — changed: benchmarks
- `z-ai/glm-5` — changed: context_length, pricing, top_provider, benchmarks
- `z-ai/glm-5-turbo` — changed: benchmarks
- `z-ai/glm-5.1` — changed: benchmarks
- `z-ai/glm-5.2` — changed: pricing, benchmarks
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- **Auto Router (Beta)** (`openrouter/auto-beta`)
...
- `google/gemini-3.1-pro-preview` — changed: benchmarks
- `google/gemini-3.5-flash` — changed: benchmarks
- `google/gemma-4-31b-it` — changed: supported_parameters
- `inception/mercury-2` — changed: benchmarks
- `mancer/weaver` — changed: pricing
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `meta/muse-spark-1.1` — changed: benchmarks
- `minimax/minimax-m2` — changed: benchmarks
...
- `z-ai/glm-4.6` — changed: benchmarks
- `z-ai/glm-4.7` — changed: benchmarks
- `z-ai/glm-4.7-flash` — changed: context_length, pricing, top_provider, benchmarks
- `z-ai/glm-5` — changed: benchmarks
- `z-ai/glm-5-turbo` — changed: benchmarks
- `z-ai/glm-5.1` — changed: benchmarks
- `z-ai/glm-5.2` — changed: pricing, benchmarks
...
- `~moonshotai/kimi-latest` — changed: context_length, pricing, top_provider, supported_parameters, reasoning
- `amazon/nova-premier-v1` — changed: benchmarks
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
...
- `mistralai/mistral-medium-3` — changed: benchmarks
- `mistralai/mistral-medium-3.1` — changed: benchmarks
- `mistralai/mistral-nemo` — changed: pricing
- `mistralai/mistral-small-3.2-24b-instruct` — changed: benchmarks
- `moonshotai/kimi-k2` — changed: benchmarks
- `moonshotai/kimi-k2-0905` — changed: benchmarks
- `moonshotai/kimi-k2-thinking` — changed: benchmarks
...
- `openai/o3` — changed: benchmarks
- `openai/o4-mini` — changed: benchmarks
- `poolside/laguna-m.1` — changed: expiration_date
- `poolside/laguna-m.1:free` — changed: expiration_date
- `qwen/qwen3-14b` — changed: pricing, top_provider
- `qwen/qwen3-235b-a22b` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: benchmarks
...
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3.5-397b-a17b` — changed: pricing, benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
...
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: top_provider, benchmarks
- `anthropic/claude-haiku-4.5` — changed: top_provider, benchmarks
- `anthropic/claude-opus-4` — changed: benchmarks
- `anthropic/claude-opus-4.1` — changed: benchmarks
- `anthropic/claude-opus-4.5` — changed: benchmarks
- `anthropic/claude-opus-4.6` — changed: benchmarks
- `anthropic/claude-opus-4.7` — changed: benchmarks
- `anthropic/claude-opus-4.8` — changed: top_provider, benchmarks
- `anthropic/claude-sonnet-4` — changed: top_provider, benchmarks
- `anthropic/claude-sonnet-4.5` — changed: benchmarks
- `anthropic/claude-sonnet-4.6` — changed: benchmarks
...
- `deepseek/deepseek-chat-v3.1` — changed: benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-v3.1-terminus` — changed: context_length, pricing, top_provider, benchmarks
- `deepseek/deepseek-v3.2` — changed: context_length, pricing, top_provider, benchmarks
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
- `deepseek/deepseek-v4-flash` — changed: pricing, top_provider, benchmarks
- `deepseek/deepseek-v4-pro` — changed: benchmarks
- `google/gemini-2.5-flash` — changed: benchmarks
- `google/gemini-2.5-flash-image` — changed: top_provider
- `google/gemini-2.5-pro` — changed: benchmarks
- `google/gemini-3-flash-preview` — changed: benchmarks
- `google/gemini-3.1-flash-image-preview` — changed: benchmarks
- `google/gemini-3.1-flash-lite-image` — changed: top_provider
...
- `minimax/minimax-m2.5` — changed: benchmarks
- `minimax/minimax-m2.7` — changed: pricing, top_provider, benchmarks
- `minimax/minimax-m3` — changed: top_provider, benchmarks
- `mistralai/codestral-2508` — changed: supported_parameters, benchmarks
- `mistralai/ministral-14b-2512` — changed: benchmarks
- `mistralai/ministral-3b-2512` — changed: benchmarks
- `mistralai/ministral-8b-2512` — changed: benchmarks
- `mistralai/mistral-large-2512` — changed: benchmarks
- `mistralai/mistral-medium-3` — changed: benchmarks
- `mistralai/mistral-medium-3.1` — changed: benchmarks
- `mistralai/mistral-nemo` — changed: pricing, top_provider
- `mistralai/mistral-small-3.2-24b-instruct` — changed: context_length, pricing, top_provider, benchmarks
- `moonshotai/kimi-k2` — changed: benchmarks
- `moonshotai/kimi-k2-0905` — changed: benchmarks
- `moonshotai/kimi-k2-thinking` — changed: pricing, top_provider, benchmarks
...
- `openai/gpt-3.5-turbo-16k` — changed: top_provider
- `openai/gpt-4` — changed: top_provider
- `openai/gpt-4.1` — changed: top_provider, benchmarks
- `openai/gpt-4.1-mini` — changed: benchmarks
- `openai/gpt-4.1-nano` — changed: benchmarks
- `openai/gpt-4o` — changed: pricing, top_provider, supported_parameters, benchmarks
- `openai/gpt-4o-2024-05-13` — changed: supported_parameters
- `openai/gpt-4o-2024-08-06` — changed: top_provider, supported_parameters
- `openai/gpt-4o-2024-11-20` — changed: supported_parameters
- `openai/gpt-4o-mini` — changed: top_provider, supported_parameters
- `openai/gpt-4o-mini-2024-07-18` — changed: supported_parameters
- `openai/gpt-5` — changed: top_provider, benchmarks
- `openai/gpt-5-codex` — changed: benchmarks
- `openai/gpt-5-image` — changed: benchmarks
- `openai/gpt-5-mini` — changed: benchmarks
- `openai/gpt-5-nano` — changed: benchmarks
...
- `openai/gpt-5.2` — changed: benchmarks
- `openai/gpt-5.2-codex` — changed: benchmarks
- `openai/gpt-5.3-chat` — changed: top_provider, expiration_date
- `openai/gpt-5.3-codex` — changed: benchmarks
- `openai/gpt-5.4` — changed: benchmarks
- `openai/gpt-5.4-nano` — changed: top_provider
- `openai/gpt-5.4-pro` — changed: top_provider
- `openai/gpt-5.5` — changed: benchmarks
- `openai/gpt-5.6-sol-pro` — changed: top_provider
- `openai/gpt-5.6-terra` — changed: top_provider
- `openai/gpt-oss-120b` — changed: pricing, benchmarks
- `openai/gpt-oss-20b` — changed: pricing, top_provider, benchmarks
- `openai/gpt-oss-20b:free` — changed: benchmarks
- `openai/o3` — changed: benchmarks
...
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3-next-80b-a3b-instruct` — changed: pricing, top_provider
- `qwen/qwen3-vl-235b-a22b-instruct` — changed: context_length, pricing, top_provider
- `qwen/qwen3.5-122b-a10b` — changed: top_provider
- `qwen/qwen3.5-35b-a3b` — changed: pricing, top_provider
...
- `qwen/qwen3.6-27b` — changed: pricing, top_provider
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: pricing, benchmarks
- `qwen/qwen3.7-plus` — changed: benchmarks
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: pricing, top_provider, benchmarks
- `tencent/hy3:free` — changed: benchmarks
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
...
- `z-ai/glm-4.5` — changed: benchmarks
- `z-ai/glm-4.5-air` — changed: benchmarks
- `z-ai/glm-4.6` — changed: context_length, pricing, top_provider, benchmarks
- `z-ai/glm-4.7` — changed: benchmarks
- `z-ai/glm-4.7-flash` — changed: benchmarks
- `z-ai/glm-5` — changed: pricing, top_provider, benchmarks
- `z-ai/glm-5-turbo` — changed: context_length, top_provider, supported_parameters, expiration_date, benchmarks
- `z-ai/glm-5.1` — changed: benchmarks
- `z-ai/glm-5.2` — changed: pricing, benchmarks
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- `tencent/hy3` — changed: benchmarks
- `tencent/hy3:free` — changed: benchmarks
- `thedrummer/rocinante-12b` — changed: supported_parameters
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.3` — changed: benchmarks
- `x-ai/grok-4.5` — changed: benchmarks
- `xiaomi/mimo-v2.5` — changed: benchmarks
...
- `z-ai/glm-4.7` — changed: benchmarks
- `z-ai/glm-4.7-flash` — changed: benchmarks
- `z-ai/glm-5` — changed: top_provider, benchmarks
- `z-ai/glm-5-turbo` — changed: benchmarks
- `z-ai/glm-5.1` — changed: benchmarks
- `z-ai/glm-5.2` — changed: pricing, top_provider, benchmarks
- `z-ai/glm-5v-turbo` — changed: benchmarks
...
- `~anthropic/claude-haiku-latest` — changed: top_provider
- `~google/gemini-flash-latest` — changed: pricing
- `~google/gemini-pro-latest` — changed: pricing
- `~openai/gpt-latest` — changed: pricing
- `~x-ai/grok-latest` — changed: pricing
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: benchmarks
- `anthropic/claude-haiku-4.5` — changed: top_provider, benchmarks
- `anthropic/claude-opus-4` — changed: benchmarks
- `anthropic/claude-opus-4.1` — changed: benchmarks
- `anthropic/claude-opus-4.5` — changed: benchmarks
- `anthropic/claude-opus-4.6` — changed: top_provider, benchmarks
- `anthropic/claude-opus-4.7` — changed: top_provider, benchmarks
- `anthropic/claude-opus-4.8` — changed: benchmarks
...
- `anthropic/claude-sonnet-5` — changed: benchmarks
- `arcee-ai/trinity-large-thinking` — changed: benchmarks
- `bytedance-seed/seed-1.6` — changed: pricing
- `bytedance-seed/seed-1.6-flash` — changed: pricing
- `bytedance-seed/seed-2.0-lite` — changed: pricing
- `bytedance-seed/seed-2.0-mini` — changed: pricing
- `deepseek/deepseek-chat` — changed: benchmarks
- `deepseek/deepseek-chat-v3.1` — changed: pricing, benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-v3.1-terminus` — changed: benchmarks
- `deepseek/deepseek-v3.2` — changed: benchmarks
- `deepseek/deepseek-v3.2-exp` — changed: benchmarks
...
- `deepseek/deepseek-v4-pro` — changed: benchmarks
- `google/gemini-2.5-flash` — changed: pricing, benchmarks
- `google/gemini-2.5-flash-image` — changed: pricing, benchmarks
- `google/gemini-2.5-flash-lite` — changed: pricing
- `google/gemini-2.5-pro` — changed: pricing, benchmarks
- `google/gemini-2.5-pro-preview` — changed: pricing
- `google/gemini-2.5-pro-preview-05-06` — changed: pricing
- `google/gemini-3-flash-preview` — changed: pricing, benchmarks
- `google/gemini-3-pro-image` — changed: pricing
- `google/gemini-3-pro-image-preview` — changed: pricing, benchmarks
- `google/gemini-3.1-flash-image` — changed: pricing
- `google/gemini-3.1-flash-image-preview` — changed: pricing, benchmarks
- `google/gemini-3.1-flash-lite` — changed: pricing
- `google/gemini-3.1-flash-lite-image` — changed: pricing
- `google/gemini-3.1-flash-lite-preview` — changed: pricing, supported_parameters, benchmarks
- `google/gemini-3.1-pro-preview` — changed: pricing, benchmarks
- `google/gemini-3.1-pro-preview-customtools` — changed: pricing
- `google/gemini-3.5-flash` — changed: pricing, benchmarks
- `google/gemma-4-31b-it:free` — changed: top_provider, supported_parameters
- `inception/mercury-2` — changed: benchmarks
- `kwaipilot/kat-coder-pro-v2` — changed: benchmarks
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
...
- `openai/gpt-4o` — changed: benchmarks
- `openai/gpt-5` — changed: benchmarks
- `openai/gpt-5-image` — changed: pricing, benchmarks
- `openai/gpt-5-image-mini` — changed: pricing, benchmarks
- `openai/gpt-5-mini` — changed: benchmarks
- `openai/gpt-5-nano` — changed: pricing, top_provider, benchmarks
- `openai/gpt-5.1` — changed: pricing, top_provider, benchmarks
- `openai/gpt-5.1-codex` — changed: benchmarks
- `openai/gpt-5.1-codex-mini` — changed: benchmarks
- `openai/gpt-5.2` — changed: benchmarks
- `openai/gpt-5.2-codex` — changed: benchmarks
- `openai/gpt-5.3-codex` — changed: benchmarks
- `openai/gpt-5.4` — changed: pricing, benchmarks
- `openai/gpt-5.4-image-2` — changed: pricing
- `openai/gpt-5.4-pro` — changed: pricing
- `openai/gpt-5.5` — changed: pricing, benchmarks
- `openai/gpt-5.5-pro` — changed: pricing
- `openai/gpt-5.6-luna` — changed: pricing
- `openai/gpt-5.6-luna-pro` — changed: pricing
- `openai/gpt-5.6-sol` — changed: pricing
- `openai/gpt-5.6-sol-pro` — changed: pricing
- `openai/gpt-5.6-terra` — changed: pricing
- `openai/gpt-5.6-terra-pro` — changed: pricing
- `openai/gpt-audio` — changed: pricing
- `openai/gpt-audio-mini` — changed: pricing
- `openai/gpt-oss-120b` — changed: pricing, top_provider, benchmarks
- `openai/gpt-oss-20b` — changed: benchmarks
- `openai/gpt-oss-20b:free` — changed: supported_parameters, benchmarks
- `openai/o3` — changed: benchmarks
- `openai/o4-mini` — changed: benchmarks
- `openrouter/free` — changed: supported_parameters
- `qwen/qwen-plus` — changed: pricing
- `qwen/qwen-plus-2025-07-28` — changed: pricing
- `qwen/qwen-plus-2025-07-28:thinking` — changed: pricing
- `qwen/qwen3-235b-a22b` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
- `qwen/qwen3-235b-a22b-thinking-2507` — changed: benchmarks
- `qwen/qwen3-30b-a3b` — changed: benchmarks
...
- `qwen/qwen3-coder` — changed: benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: benchmarks
- `qwen/qwen3-coder-flash` — changed: pricing
- `qwen/qwen3-coder-plus` — changed: pricing
- `qwen/qwen3-coder:free` — changed: benchmarks
- `qwen/qwen3-max` — changed: pricing, benchmarks
- `qwen/qwen3-max-thinking` — changed: pricing
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: pricing, benchmarks
- `qwen/qwen3.5-plus-20260420` — changed: pricing
- `qwen/qwen3.6-27b` — changed: pricing, top_provider
- `qwen/qwen3.6-flash` — changed: pricing
- `qwen/qwen3.6-max-preview` — changed: pricing
- `qwen/qwen3.6-plus` — changed: pricing, benchmarks
- `qwen/qwen3.7-max` — changed: benchmarks
- `qwen/qwen3.7-plus` — changed: pricing, benchmarks
- `sakana/fugu-ultra` — changed: pricing
- `stepfun/step-3.7-flash` — changed: benchmarks
- `tencent/hy3` — changed: benchmarks
- `tencent/hy3-preview` — changed: benchmarks
- `tencent/hy3:free` — changed: benchmarks
- `x-ai/grok-4.20` — changed: pricing, benchmarks
- `x-ai/grok-4.20-multi-agent` — changed: pricing
- `x-ai/grok-4.3` — changed: pricing, benchmarks
- `x-ai/grok-4.5` — changed: pricing, benchmarks
- `x-ai/grok-build-0.1` — changed: pricing
- `xiaomi/mimo-v2.5` — changed: top_provider, benchmarks
- `xiaomi/mimo-v2.5-pro` — changed: benchmarks
- `z-ai/glm-4.5` — changed: benchmarks
- `z-ai/glm-4.5-air` — changed: benchmarks
- `z-ai/glm-4.6` — changed: benchmarks
...
- `anthropic/claude-sonnet-5` — changed: benchmarks
- `arcee-ai/trinity-large-thinking` — changed: benchmarks
- `cognitivecomputations/dolphin-mistral-24b-venice-edition:free` — changed: expiration_date
- `deepseek/deepseek-chat` — changed: benchmarks
- `deepseek/deepseek-chat-v3.1` — changed: benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-v3.1-terminus` — changed: benchmarks
...
- `google/gemini-3.5-flash` — changed: benchmarks
- `inception/mercury-2` — changed: benchmarks
- `meta-llama/llama-3.2-3b-instruct:free` — changed: expiration_date
- `meta-llama/llama-3.3-70b-instruct:free` — changed: expiration_date
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `minimax/minimax-m2` — changed: benchmarks
- `minimax/minimax-m2.1` — changed: benchmarks
...
- `moonshotai/kimi-k2.7-code` — changed: pricing, benchmarks
- `nex-agi/nex-n2-pro` — changed: benchmarks
- `nousresearch/hermes-3-llama-3.1-405b:free` — changed: expiration_date
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: benchmarks
- `openai/gpt-4.1` — changed: benchmarks
- `openai/gpt-4.1-mini` — changed: benchmarks
...
- `qwen/qwen3-coder` — changed: benchmarks
- `qwen/qwen3-coder-30b-a3b-instruct` — changed: benchmarks
- `qwen/qwen3-coder:free` — changed: expiration_date, benchmarks
- `qwen/qwen3-max` — changed: benchmarks
- `qwen/qwen3-next-80b-a3b-instruct:free` — changed: expiration_date
- `qwen/qwen3.5-397b-a17b` — changed: benchmarks
- `qwen/qwen3.5-plus-02-15` — changed: benchmarks
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: benchmarks
...
- `~anthropic/claude-sonnet-latest` — changed: supported_parameters
- `~google/gemini-flash-latest` — changed: supported_parameters
- `~google/gemini-pro-latest` — changed: supported_parameters
- `~moonshotai/kimi-latest` — changed: pricing
- `~openai/gpt-latest` — changed: pricing, supported_parameters, knowledge_cutoff, reasoning
- `~openai/gpt-mini-latest` — changed: supported_parameters
- `~x-ai/grok-latest` — changed: supported_parameters
- `amazon/nova-premier-v1` — changed: benchmarks
- `amazon/nova-pro-v1` — changed: benchmarks
- `anthropic/claude-fable-5` — changed: supported_parameters, benchmarks
- `anthropic/claude-haiku-4.5` — changed: benchmarks
- `anthropic/claude-opus-4` — changed: benchmarks
- `anthropic/claude-opus-4.1` — changed: benchmarks
- `anthropic/claude-opus-4.5` — changed: benchmarks
- `anthropic/claude-opus-4.6` — changed: supported_parameters, benchmarks
- `anthropic/claude-opus-4.7` — changed: supported_parameters, benchmarks
- `anthropic/claude-opus-4.7-fast` — changed: supported_parameters
- `anthropic/claude-opus-4.8` — changed: supported_parameters, benchmarks
- `anthropic/claude-opus-4.8-fast` — changed: supported_parameters
- `anthropic/claude-sonnet-4` — changed: benchmarks
- `anthropic/claude-sonnet-4.5` — changed: benchmarks
- `anthropic/claude-sonnet-4.6` — changed: supported_parameters, benchmarks
- `anthropic/claude-sonnet-5` — changed: supported_parameters, benchmarks
- `arcee-ai/trinity-large-thinking` — changed: benchmarks
- `bytedance-seed/seed-2.0-lite` — changed: supported_parameters
- `bytedance-seed/seed-2.0-mini` — changed: supported_parameters
- `deepseek/deepseek-chat` — changed: benchmarks
- `deepseek/deepseek-chat-v3.1` — changed: benchmarks
- `deepseek/deepseek-r1-0528` — changed: benchmarks
- `deepseek/deepseek-v3.1-terminus` — changed: benchmarks
...
- `google/gemini-2.5-flash-image` — changed: benchmarks
- `google/gemini-2.5-pro` — changed: benchmarks
- `google/gemini-3-flash-preview` — changed: supported_parameters, benchmarks
- `google/gemini-3-pro-image-preview` — changed: benchmarks
- `google/gemini-3.1-flash-image` — changed: supported_parameters
- `google/gemini-3.1-flash-image-preview` — changed: supported_parameters, benchmarks
- `google/gemini-3.1-flash-lite` — changed: supported_parameters
- `google/gemini-3.1-flash-lite-image` — changed: supported_parameters
- `google/gemini-3.1-flash-lite-preview` — changed: supported_parameters, benchmarks
- `google/gemini-3.1-pro-preview` — changed: supported_parameters, benchmarks
- `google/gemini-3.1-pro-preview-customtools` — changed: supported_parameters
- `google/gemini-3.5-flash` — changed: supported_parameters, benchmarks
- `inception/mercury-2` — changed: supported_parameters, benchmarks
- `inclusionai/ring-2.6-1t` — changed: supported_parameters
- `meta-llama/llama-4-maverick` — changed: benchmarks
- `meta-llama/llama-4-scout` — changed: benchmarks
- `minimax/minimax-m2` — changed: benchmarks
- `minimax/minimax-m2.1` — changed: benchmarks
- `minimax/minimax-m2.5` — changed: pricing, supported_parameters, benchmarks
- `minimax/minimax-m2.7` — changed: pricing, benchmarks
- `minimax/minimax-m3` — changed: top_provider, benchmarks
- `mistralai/codestral-2508` — changed: benchmarks
- `mistralai/ministral-14b-2512` — changed: benchmarks
...
- `mistralai/mistral-large-2512` — changed: benchmarks
- `mistralai/mistral-medium-3` — changed: benchmarks
- `mistralai/mistral-medium-3-5` — changed: supported_parameters
- `mistralai/mistral-medium-3.1` — changed: benchmarks
- `mistralai/mistral-small-2603` — changed: supported_parameters
- `mistralai/mistral-small-3.2-24b-instruct` — changed: benchmarks
- `moonshotai/kimi-k2` — changed: benchmarks
...
- `moonshotai/kimi-k2.5` — changed: benchmarks
- `moonshotai/kimi-k2.6` — changed: pricing, benchmarks
- `moonshotai/kimi-k2.7-code` — changed: pricing, top_provider, supported_parameters, benchmarks
- `nex-agi/nex-n2-pro` — changed: benchmarks
- `nvidia/nemotron-3-super-120b-a12b` — changed: supported_parameters
- `nvidia/nemotron-3-super-120b-a12b:free` — changed: supported_parameters
- `nvidia/nemotron-3-ultra-550b-a55b` — changed: supported_parameters, benchmarks
- `nvidia/nemotron-3-ultra-550b-a55b:free` — changed: supported_parameters, benchmarks
- `openai/gpt-4.1` — changed: benchmarks
- `openai/gpt-4.1-mini` — changed: benchmarks
- `openai/gpt-4.1-nano` — changed: benchmarks
- `openai/gpt-4o` — changed: benchmarks
...
- `openai/gpt-oss-120b:free` — changed: supported_parameters, benchmarks
- `openai/gpt-oss-20b` — changed: supported_parameters, benchmarks
- `openai/gpt-oss-20b:free` — changed: supported_parameters, benchmarks
- `openai/o3` — changed: benchmarks
- `openai/o3-mini-high` — changed: supported_parameters
- `openai/o4-mini` — changed: benchmarks
- `openai/o4-mini-high` — changed: supported_parameters
- `openrouter/auto` — changed: supported_parameters
- `openrouter/free` — changed: supported_parameters
- `qwen/qwen3-235b-a22b` — changed: benchmarks
- `qwen/qwen3-235b-a22b-2507` — changed: benchmarks
...
- `qwen/qwen3.6-plus` — changed: benchmarks
- `qwen/qwen3.7-max` — changed: benchmarks
- `sakana/fugu-ultra` — changed: supported_parameters
- `stepfun/step-3.7-flash` — changed: supported_parameters, benchmarks
- `tencent/hy3` — changed: supported_parameters
- `tencent/hy3-preview` — changed: supported_parameters
- `tencent/hy3:free` — changed: supported_parameters
- `x-ai/grok-4.20` — changed: benchmarks
- `x-ai/grok-4.20-multi-agent` — changed: supported_parameters
- `x-ai/grok-4.3` — changed: supported_parameters, benchmarks
- `x-ai/grok-4.5` — changed: supported_parameters, benchmarks
- `xiaomi/mimo-v2.5` — changed: benchmarks
- `xiaomi/mimo-v2.5-pro` — changed: benchmarks
- `z-ai/glm-4.5` — changed: benchmarks
- `z-ai/glm-4.5-air` — changed: benchmarks
